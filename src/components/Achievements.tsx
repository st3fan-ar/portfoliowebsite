...
export default function Achievements() {
  ...
  return (
    <section id="achievements" className="py-32 px-6 bg-[var(--bg-secondary)]/50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {achievements.map((achievement, index) => (
            <div
              key={index}
              className="bg-[var(--bg-primary)] border border-[#e5e4dc] rounded-2xl p-8 card-hover group"
            >
              ...
              <h3 className="font-heading text-2xl font-bold mb-3 text-[var(--text-primary)]">{achievement.title}</h3>
